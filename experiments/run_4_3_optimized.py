...
LOG_FILE = Path('/opt/moss/experiments/run_4_3_actions.jsonl')
STATUS_FILE = Path('/opt/moss/experiments/run_4_3_status.json')
CHECKPOINT_DIR = Path('/opt/moss/experiments/.checkpoints_run4_3')
