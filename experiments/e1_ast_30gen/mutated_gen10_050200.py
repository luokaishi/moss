...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.25, 0.25, 0.25, 0.25]), 'concerned': np.array([0.3786, 0.3018, 0.1616, 0.2248]), 'normal': np.array([0.2, 0.2794, 0.3, 0.1]), 'growth': np.array([0.2, 0.2, 0.4, 0.2])}
