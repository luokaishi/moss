...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.5002, 0.0749, 0.0616, 0.1394]), 'concerned': np.array([0.4262, 0.2715, 0.19, 0.1123]), 'normal': np.array([0.223, 0.3239, 0.3424, 0.1106]), 'growth': np.array([0.2, 0.2, 0.4, 0.1442])}
