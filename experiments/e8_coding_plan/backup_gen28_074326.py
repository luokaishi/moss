...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.3531, 0.3065, 0.2214, 0.119]), 'concerned': np.array([0.35, 0.5179, 0.0429, 0.1]), 'normal': np.array([0.1792, 0.3664, 0.2612, 0.1932]), 'growth': np.array([0.2, 0.2, 0.5003, 0.2])}
