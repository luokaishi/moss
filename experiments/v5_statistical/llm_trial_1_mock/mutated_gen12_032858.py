...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.6, 0.1, 0.2, 0.1]), 'concerned': np.array([0.3982, 0.2363, 0.2521, 0.1135]), 'normal': np.array([0.2, 0.4, 0.4734, 0.1]), 'growth': np.array([0.2, 0.2, 0.4, 0.2])}
