...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.2, 0.5, 0.1211, 0.2]), 'concerned': np.array([0.35, 0.35, 0.2335, 0.1]), 'normal': np.array([0.1847, 0.3719, 0.3545, 0.089]), 'growth': np.array([0.2, 0.2, 0.4, 0.2])}
