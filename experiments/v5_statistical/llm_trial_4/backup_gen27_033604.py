...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.1, 0.1, 0.7, 0.0783]), 'concerned': np.array([0.2624, 0.4322, 0.162, 0.1434]), 'normal': np.array([0.1931, 0.2938, 0.3073, 0.1727]), 'growth': np.array([0.2842, 0.1516, 0.3203, 0.2439])}
