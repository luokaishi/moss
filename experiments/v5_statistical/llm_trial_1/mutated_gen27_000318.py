...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.161, 0.1375, 0.5362, 0.1652]), 'concerned': np.array([0.35, 0.35, 0.2, 0.1209]), 'normal': np.array([0.2, 0.4, 0.3, 0.0737]), 'growth': np.array([0.2, 0.2, 0.4836, 0.2088])}
