...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.4, 0.3, 0.2, 0.1]), 'concerned': np.array([0.3301, 0.3163, 0.2414, 0.1122]), 'normal': np.array([0.1339, 0.4, 0.3, 0.01]), 'growth': np.array([0.2, 0.2, 0.4, 0.2])}
