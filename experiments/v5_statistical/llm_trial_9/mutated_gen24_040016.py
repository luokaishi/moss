...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.5, 0.2, 0.2, 0.0824]), 'concerned': np.array([0.35, 0.3563, 0.2, 0.1]), 'normal': np.array([0.2, 0.4, 0.349, 0.1]), 'growth': np.array([0.2, 0.2, 0.5375, 0.1826])}
