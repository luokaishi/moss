...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.6, 0.1, 0.2, 0.1]), 'concerned': np.array([0.35, 0.3228, 0.2, 0.1]), 'normal': np.array([0.2506, 0.4, 0.3, 0.1572]), 'growth': np.array([0.1888, 0.2943, 0.3047, 0.2122])}
