...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.2, 0.5, 0.1, 0.1848]), 'concerned': np.array([0.4039, 0.2639, 0.1661, 0.1661]), 'normal': np.array([0.2, 0.3318, 0.346, 0.1]), 'growth': np.array([0.1786, 0.2611, 0.3047, 0.262])}
