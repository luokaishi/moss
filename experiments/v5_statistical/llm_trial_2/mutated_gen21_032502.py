...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.2, 0.5, 0.1, 0.1848]), 'concerned': np.array([0.3092, 0.2256, 0.2838, 0.1814]), 'normal': np.array([0.2, 0.3318, 0.346, 0.1]), 'growth': np.array([0.1786, 0.405, 0.3047, 0.262])}
