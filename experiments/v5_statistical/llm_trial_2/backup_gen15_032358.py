...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.2, 0.5, 0.1, 0.2]), 'concerned': np.array([0.35, 0.35, 0.2, 0.1]), 'normal': np.array([0.2, 0.3318, 0.346, 0.1]), 'growth': np.array([0.1786, 0.2611, 0.3047, 0.262])}
