...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.25, 0.25, 0.25, 0.25]), 'concerned': np.array([0.35, 0.35, 0.2, 0.1]), 'normal': np.array([0.3281, 0.2838, 0.2193, 0.1688]), 'growth': np.array([0.2666, 0.2, 0.4, 0.2])}
