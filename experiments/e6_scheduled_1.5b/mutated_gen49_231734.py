...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.1832, 0.433, 0.1146, 0.2574]), 'concerned': np.array([0.35, 0.4209, 0.2006, 0.1]), 'normal': np.array([0.245, 0.4, 0.3, 0.1149]), 'growth': np.array([0.316, 0.1551, 0.4081, 0.2])}
