...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.4, 0.3, 0.2, 0.1]), 'concerned': np.array([0.35, 0.35, 0.2, 0.098]), 'normal': np.array([0.2, 0.2769, 0.3, 0.1235]), 'growth': np.array([0.1553, 0.1841, 0.4437, 0.2169])}
