...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.25, 0.25, 0.2586, 0.25]), 'concerned': np.array([0.2732, 0.1805, 0.2768, 0.2694]), 'normal': np.array([0.0101, 0.4, 0.3, 0.1263]), 'growth': np.array([0.2, 0.2374, 0.1917, 0.1783])}
