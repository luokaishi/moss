...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.1, 0.1, 0.7, 0.1]), 'concerned': np.array([0.0297, 0.1166, 0.3152, 0.2794]), 'normal': np.array([0.0617, 0.4677, 0.2857, 0.1533]), 'growth': np.array([0.2, 0.2809, 0.2874, 0.0561])}
