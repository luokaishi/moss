...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.5049, 0.1685, 0.2458, 0.0808]), 'concerned': np.array([0.3217, 0.2481, 0.2377, 0.1925]), 'normal': np.array([0.01, 0.4, 0.3, 0.1]), 'growth': np.array([0.2, 0.2374, 0.205, 0.2])}
