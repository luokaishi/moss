...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.4396, 0.0726, 0.3719, 0.1159]), 'concerned': np.array([0.35, 0.35, 0.2, 0.1]), 'normal': np.array([0.223, 0.3239, 0.3424, 0.1106]), 'growth': np.array([0.2, 0.2, 0.4, 0.1442])}
