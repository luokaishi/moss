...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.2248, 0.2815, 0.1567, 0.337]), 'concerned': np.array([0.2755, 0.288, 0.148, 0.2885]), 'normal': np.array([0.2, 0.4, 0.3, 0.2398]), 'growth': np.array([0.1517, 0.2576, 0.4239, 0.2174])}
