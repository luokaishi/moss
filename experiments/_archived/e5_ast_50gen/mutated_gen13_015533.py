...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.2834, 0.3332, 0.2065, 0.1769]), 'concerned': np.array([0.2755, 0.288, 0.148, 0.2885]), 'normal': np.array([0.2, 0.4, 0.3, 0.2398]), 'growth': np.array([0.1839, 0.2768, 0.306, 0.1699])}
