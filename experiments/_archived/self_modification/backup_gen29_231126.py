...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.4, 0.3, 0.2, 0.1]), 'concerned': np.array([0.2644, 0.35, 0.2, 0.3083]), 'normal': np.array([0.3391, 0.289, 0.2633, 0.1086]), 'growth': np.array([0.2261, 0.2, 0.513, 0.2])}
