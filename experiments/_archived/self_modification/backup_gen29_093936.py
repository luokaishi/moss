...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.6, 0.1, 0.2, 0.1]), 'concerned': np.array([0.3967, 0.2725, 0.1926, 0.1382]), 'normal': np.array([0.1653, 0.4, 0.3, 0.1]), 'growth': np.array([0.2836, 0.2, 0.4, 0.2])}
