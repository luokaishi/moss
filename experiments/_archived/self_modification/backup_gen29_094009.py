...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.25, 0.25, 0.25, 0.1607]), 'concerned': np.array([0.2017, 0.35, 0.2, 0.1]), 'normal': np.array([0.128, 0.5044, 0.2012, 0.098]), 'growth': np.array([0.2, 0.2, 0.4, 0.2])}
