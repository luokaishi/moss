...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.4192, 0.0799, 0.2655, 0.2354]), 'concerned': np.array([0.3079, 0.35, 0.2, 0.1]), 'normal': np.array([0.2739, 0.4, 0.3, 0.0073]), 'growth': np.array([0.1958, 0.2036, 0.3703, 0.2303])}
