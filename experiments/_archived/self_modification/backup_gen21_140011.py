...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.1485, 0.1062, 0.2325, 0.5128]), 'concerned': np.array([0.35, 0.35, 0.2008, 0.1]), 'normal': np.array([0.1366, 0.4, 0.3, 0.1]), 'growth': np.array([0.2, 0.1535, 0.4, 0.2])}
