...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.1, 0.7, 0.1, 0.1]), 'concerned': np.array([0.35, 0.35, 0.2, 0.3602]), 'normal': np.array([0.2011, 0.3388, 0.3027, 0.1425]), 'growth': np.array([0.1838, 0.3072, 0.3226, 0.1864])}
