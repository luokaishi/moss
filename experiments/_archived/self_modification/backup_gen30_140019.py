...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.3231, 0.1062, 0.2325, 0.5128]), 'concerned': np.array([0.35, 0.35, 0.2008, 0.1]), 'normal': np.array([0.1366, 0.4, 0.3, 0.1]), 'growth': np.array([0.2574, 0.1398, 0.2989, 0.2527])}
