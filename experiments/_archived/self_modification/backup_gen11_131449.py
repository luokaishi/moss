...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.5079, 0.1, 0.2, 0.1]), 'concerned': np.array([0.2973, 0.305, 0.2276, 0.1701]), 'normal': np.array([0.1653, 0.4, 0.3, 0.0728]), 'growth': np.array([0.2, 0.2, 0.4, 0.2])}
