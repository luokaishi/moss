...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.25, 0.25, 0.25, 0.25]), 'concerned': np.array([0.2714, 0.35, 0.2, 0.3083]), 'normal': np.array([0.2679, 0.3922, 0.2248, 0.1151]), 'growth': np.array([0.2261, 0.2, 0.513, 0.2])}
