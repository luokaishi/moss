...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.9232, 0.1, 0.1, 0.1]), 'concerned': np.array([0.3201, 0.2363, 0.3496, 0.094]), 'normal': np.array([0.1783, 0.348, 0.3143, 0.1595]), 'growth': np.array([0.2, 0.1535, 0.3159, 0.2])}
