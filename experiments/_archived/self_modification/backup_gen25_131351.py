...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.5, 0.2, 0.2, 0.1]), 'concerned': np.array([0.2873, 0.35, 0.1707, 0.1921]), 'normal': np.array([0.1653, 0.4, 0.2255, 0.1]), 'growth': np.array([0.2214, 0.0169, 0.3707, 0.1967])}
