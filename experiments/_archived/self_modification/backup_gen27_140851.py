...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.5828, 0.0941, 0.1793, 0.1438]), 'concerned': np.array([0.3375, 0.2553, 0.2, 0.2659]), 'normal': np.array([0.1579, 0.4, 0.3, 0.01]), 'growth': np.array([0.2, 0.2, 0.4324, 0.2])}
