...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.25, 0.25, 0.25, 0.25]), 'concerned': np.array([0.2577, 0.322, 0.1592, 0.2057]), 'normal': np.array([0.1428, 0.4759, 0.3, 0.0686]), 'growth': np.array([0.2, 0.2004, 0.4, 0.2])}
