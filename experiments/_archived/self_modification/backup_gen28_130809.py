...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.6, 0.1, 0.2, 0.1]), 'concerned': np.array([0.3547, 0.3137, 0.1807, 0.1508]), 'normal': np.array([0.1359, 0.3083, 0.2657, 0.2203]), 'growth': np.array([0.1774, 0.2, 0.4, 0.1447])}
