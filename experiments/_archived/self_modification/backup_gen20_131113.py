...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.6, 0.1, 0.2, 0.1]), 'concerned': np.array([0.1035, 0.35, 0.2, 0.1]), 'normal': np.array([0.1579, 0.4, 0.3, 0.1]), 'growth': np.array([0.2, 0.2, 0.4324, 0.2])}
