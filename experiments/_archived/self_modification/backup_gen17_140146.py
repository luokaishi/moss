...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.1, 0.1, 0.7, 0.1]), 'concerned': np.array([0.2696, 0.3421, 0.2436, 0.1448]), 'normal': np.array([0.1653, 0.311, 0.3, 0.1]), 'growth': np.array([0.2, 0.2, 0.4913, 0.2])}
