...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.25, 0.3942, 0.25, 0.25]), 'concerned': np.array([0.269, 0.2436, 0.1582, 0.2714]), 'normal': np.array([0.1653, 0.4096, 0.3, 0.1]), 'growth': np.array([0.2, 0.2004, 0.4, 0.2])}
