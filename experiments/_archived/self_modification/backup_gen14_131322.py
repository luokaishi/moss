...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.3856, 0.2602, 0.2005, 0.1537]), 'concerned': np.array([0.35, 0.35, 0.2, 0.3083]), 'normal': np.array([0.2679, 0.3922, 0.2248, 0.1151]), 'growth': np.array([0.2249, 0.2762, 0.3242, 0.1748])}
