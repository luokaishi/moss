...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.25, 0.25, 0.25, 0.25]), 'concerned': np.array([0.3907, 0.3477, 0.1494, 0.1123]), 'normal': np.array([0.1653, 0.5213, 0.3, 0.2007]), 'growth': np.array([0.2, 0.1877, 0.4, 0.1983])}
