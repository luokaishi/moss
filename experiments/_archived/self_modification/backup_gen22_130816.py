...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.5258, 0.1811, 0.274, 0.0815]), 'concerned': np.array([0.3019, 0.2738, 0.2287, 0.1808]), 'normal': np.array([0.2291, 0.3518, 0.2772, 0.1419]), 'growth': np.array([0.2081, 0.2481, 0.2992, 0.3586])}
