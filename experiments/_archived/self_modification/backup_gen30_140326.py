...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.1833, 0.3942, 0.25, 0.25]), 'concerned': np.array([0.2881, 0.35, 0.2, 0.1]), 'normal': np.array([0.1653, 0.4759, 0.3, 0.0555]), 'growth': np.array([0.2, 0.2004, 0.4, 0.2])}
