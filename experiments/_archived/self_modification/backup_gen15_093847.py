...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.25, 0.25, 0.25, 0.25]), 'concerned': np.array([0.3159, 0.35, 0.2, 0.1]), 'normal': np.array([0.1366, 0.4, 0.3, 0.1]), 'growth': np.array([0.2836, 0.2, 0.4, 0.2])}
