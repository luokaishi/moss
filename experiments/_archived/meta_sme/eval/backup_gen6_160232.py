...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.1, 0.1, 0.1, 0.7]), 'concerned': np.array([0.3606, 0.2737, 0.2586, 0.3101]), 'normal': np.array([0.1077, 0.4561, 0.8596, 0.1993]), 'growth': np.array([0.6116, 0.3552, 0.2557, 0.2808])}
