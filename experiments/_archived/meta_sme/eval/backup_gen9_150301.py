...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.1, 0.1, 0.1, 0.7]), 'concerned': np.array([0.2651, 0.1673, 0.3281, 0.2396]), 'normal': np.array([0.1634, 0.2209, 1.3693, 0.0139]), 'growth': np.array([0.1802, 0.3987, 0.1648, 0.181])}
