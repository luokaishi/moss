...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.7, 0.1, 0.1, 0.01]), 'concerned': np.array([0.3339, 0.2157, 0.3157, 0.1339]), 'normal': np.array([0.01, 0.3057, 0.5848, 0.3861]), 'growth': np.array([0.8599, 0.2932, 0.3659, 0.2646])}
