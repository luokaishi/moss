...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.1404, 0.1157, 0.5782, 0.1233]), 'concerned': np.array([0.2982, 0.1903, 0.3191, 0.1924]), 'normal': np.array([0.1634, 0.2209, 1.3693, 0.0139]), 'growth': np.array([0.1802, 0.3987, 0.1648, 0.181])}
