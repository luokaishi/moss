...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.1, 0.1, 0.7, 0.1]), 'concerned': np.array([0.35, 0.4396, 0.2444, 0.1]), 'normal': np.array([0.1041, 0.3819, 0.2284, 0.2543]), 'growth': np.array([0.2, 0.2002, 0.4, 0.0472])}
