...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.5112, 0.0799, 0.2763, 0.01]), 'concerned': np.array([0.292, 0.3138, 0.2077, 0.2396]), 'normal': np.array([0.238, 0.3522, 0.2528, 0.157]), 'growth': np.array([0.2423, 0.2607, 0.3029, 0.1941])}
