...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.5374, 0.0915, 0.2346, 0.1365]), 'concerned': np.array([0.292, 0.3138, 0.2077, 0.2396]), 'normal': np.array([0.1653, 0.4, 0.3, 0.1857]), 'growth': np.array([0.2, 0.2138, 0.4, 0.2])}
