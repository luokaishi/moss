...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.2, 0.5, 0.2623, 0.2]), 'concerned': np.array([0.226, 0.2539, 0.2353, 0.2847]), 'normal': np.array([0.1653, 0.311, 0.3, 0.1]), 'growth': np.array([0.1998, 0.1996, 0.4197, 0.1808])}
