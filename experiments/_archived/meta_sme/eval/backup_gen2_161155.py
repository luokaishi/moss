...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.3845, 0.3366, 0.1925, 0.0864]), 'concerned': np.array([0.3606, 0.2167, 0.2586, 0.3609]), 'normal': np.array([0.01, 0.4561, 0.63, 0.1279]), 'growth': np.array([0.6494, 0.4095, 0.2488, 0.2646])}
