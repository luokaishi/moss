...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.2568, 0.5, 0.1, 0.2]), 'concerned': np.array([0.123, 0.2356, 0.1755, 0.4261]), 'normal': np.array([0.1722, 0.3064, 0.952, 0.01]), 'growth': np.array([0.2787, 0.2634, 0.2582, 0.2393])}
