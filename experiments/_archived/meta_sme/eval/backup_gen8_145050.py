...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.304, 0.3509, 0.117, 0.2281]), 'concerned': np.array([0.1537, 0.3809, 0.2184, 0.3605]), 'normal': np.array([0.0703, 0.3064, 0.952, 0.01]), 'growth': np.array([0.312, 0.2905, 0.1008, 0.105])}
