...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.2824, 0.2392, 0.242, 0.2364]), 'concerned': np.array([0.3745, 0.1565, 0.2165, 0.1319]), 'normal': np.array([0.01, 0.3843, 0.63, 0.2067]), 'growth': np.array([0.7167, 0.4095, 0.2291, 0.2646])}
