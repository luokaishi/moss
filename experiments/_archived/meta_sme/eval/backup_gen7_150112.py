...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.1171, 0.0963, 0.1228, 0.6639]), 'concerned': np.array([0.2003, 0.2406, 0.3413, 0.2179]), 'normal': np.array([0.1634, 0.2293, 1.0882, 0.01]), 'growth': np.array([0.2938, 0.5236, 0.01, 0.1499])}
