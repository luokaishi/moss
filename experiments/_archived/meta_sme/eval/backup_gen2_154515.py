...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.4, 0.3, 0.2, 0.1]), 'concerned': np.array([0.3756, 0.3831, 0.2658, 0.01]), 'normal': np.array([0.0707, 0.3106, 0.7881, 0.3825]), 'growth': np.array([0.3292, 0.3466, 0.1579, 0.2321])}
