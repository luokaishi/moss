...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.2355, 0.4213, 0.12, 0.2232]), 'concerned': np.array([0.1424, 0.1975, 0.3926, 0.1423]), 'normal': np.array([0.1634, 0.2451, 1.3693, 0.0139]), 'growth': np.array([0.2413, 0.3305, 0.1961, 0.232])}
