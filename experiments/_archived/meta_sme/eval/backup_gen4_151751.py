...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.4, 0.3, 0.2, 0.1]), 'concerned': np.array([0.3415, 0.3715, 0.1779, 0.2322]), 'normal': np.array([0.0842, 0.2965, 1.1606, 0.0299]), 'growth': np.array([0.2718, 0.3871, 0.2405, 0.3556])}
