...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.1, 0.1, 0.7, 0.1]), 'concerned': np.array([0.3415, 0.2484, 0.1779, 0.2322]), 'normal': np.array([0.0842, 0.2965, 1.5551, 0.0279]), 'growth': np.array([0.2718, 0.3305, 0.2405, 0.3556])}
