...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.5056, 0.1561, 0.1503, 0.1881]), 'concerned': np.array([0.3375, 0.2553, 0.2, 0.0814]), 'normal': np.array([0.1579, 0.4, 0.2078, 0.01]), 'growth': np.array([0.2, 0.2, 0.5869, 0.2])}
