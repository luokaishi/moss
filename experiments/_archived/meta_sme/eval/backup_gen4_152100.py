...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.5556, 0.1381, 0.1202, 0.1861]), 'concerned': np.array([0.2565, 0.3569, 0.1933, 0.2289]), 'normal': np.array([0.0154, 0.2965, 1.0229, 0.01]), 'growth': np.array([0.2718, 0.2896, 0.26, 0.5091])}
