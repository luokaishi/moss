...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.4968, 0.2016, 0.01, 0.1498]), 'concerned': np.array([0.1246, 0.4243, 0.0908, 0.2672]), 'normal': np.array([0.1722, 0.3064, 0.952, 0.01]), 'growth': np.array([0.2685, 0.1777, 0.2979, 0.2558])}
