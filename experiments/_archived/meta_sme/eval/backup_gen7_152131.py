...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.7, 0.1, 0.1, 0.1]), 'concerned': np.array([0.2565, 0.3569, 0.1933, 0.2284]), 'normal': np.array([0.01, 0.2965, 1.0229, 0.01]), 'growth': np.array([0.2682, 0.2896, 0.26, 0.5091])}
