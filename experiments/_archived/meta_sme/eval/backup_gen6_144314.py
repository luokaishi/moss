...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.5, 0.2, 0.2, 0.1]), 'concerned': np.array([0.2497, 0.2495, 0.3085, 0.1417]), 'normal': np.array([0.1722, 0.3064, 0.9492, 0.1354]), 'growth': np.array([0.3027, 0.1869, 0.3799, 0.2212])}
