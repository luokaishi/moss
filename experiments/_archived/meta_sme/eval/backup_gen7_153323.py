...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.196, 0.1386, 0.1401, 0.5254]), 'concerned': np.array([0.4035, 0.2273, 0.2137, 0.1555]), 'normal': np.array([0.1086, 0.4872, 1.0229, 0.3133]), 'growth': np.array([0.2256, 0.4288, 0.2049, 0.497])}
