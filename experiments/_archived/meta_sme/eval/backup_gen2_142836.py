...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.686, 0.1721, 0.2, 0.1]), 'concerned': np.array([0.1807, 0.2841, 0.3552, 0.18]), 'normal': np.array([0.2817, 0.3418, 0.8815, 0.01]), 'growth': np.array([0.0203, 0.1422, 0.3703, 0.0835])}
