...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.1222, 0.0922, 0.1517, 0.7628]), 'concerned': np.array([0.3795, 0.2315, 0.2517, 0.1373]), 'normal': np.array([0.01, 0.3758, 0.63, 0.2067]), 'growth': np.array([0.6778, 0.2932, 0.3756, 0.2646])}
