...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.25, 0.25, 0.25, 0.25]), 'concerned': np.array([0.3339, 0.2157, 0.3433, 0.1339]), 'normal': np.array([0.01, 0.3057, 0.63, 0.3861]), 'growth': np.array([0.6778, 0.2932, 0.3756, 0.2646])}
