...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.1936, 0.4941, 0.1628, 0.1495]), 'concerned': np.array([0.2673, 0.2122, 0.2153, 0.3052]), 'normal': np.array([0.0075, 0.3626, 1.0229, 0.0081]), 'growth': np.array([0.238, 0.3957, 0.2509, 0.497])}
