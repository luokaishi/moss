...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.0724, 0.1536, 0.1614, 0.6125]), 'concerned': np.array([0.2436, 0.1036, 0.2658, 0.01]), 'normal': np.array([0.0707, 0.4282, 0.7756, 0.3894]), 'growth': np.array([0.6063, 0.393, 0.2706, 0.2808])}
