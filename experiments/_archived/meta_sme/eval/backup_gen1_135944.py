...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.2, 0.5, 0.1, 0.2]), 'concerned': np.array([0.3638, 0.3412, 0.1881, 0.1068]), 'normal': np.array([0.1779, 0.2877, 0.3659, 0.1685]), 'growth': np.array([0.196, 0.2401, 0.2843, 0.2542])}
