...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.2, 0.6042, 0.1, 0.2]), 'concerned': np.array([0.2635, 0.2722, 0.1858, 0.2785]), 'normal': np.array([0.0842, 0.2965, 1.5551, 0.0236]), 'growth': np.array([0.2718, 0.3305, 0.2405, 0.402])}
