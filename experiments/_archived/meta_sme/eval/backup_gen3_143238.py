...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.3207, 0.3861, 0.1887, 0.1045]), 'concerned': np.array([0.2083, 0.3334, 0.3215, 0.1369]), 'normal': np.array([0.3576, 0.2811, 0.8815, 0.01]), 'growth': np.array([0.0409, 0.3361, 0.5558, 0.0436])}
