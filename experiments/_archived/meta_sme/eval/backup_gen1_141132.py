...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.4509, 0.1732, 0.241, 0.135]), 'concerned': np.array([0.3339, 0.2491, 0.0614, 0.0814]), 'normal': np.array([0.1579, 0.4932, 0.1261, 0.01]), 'growth': np.array([0.1862, 0.2548, 0.5869, 0.1784])}
