...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.3558, 0.2435, 0.1617, 0.239]), 'concerned': np.array([0.1122, 0.3397, 0.289, 0.3605]), 'normal': np.array([0.0703, 0.2959, 0.952, 0.01]), 'growth': np.array([0.312, 0.2905, 0.0655, 0.0633])}
