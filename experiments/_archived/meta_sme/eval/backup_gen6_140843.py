...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.2066, 0.3128, 0.2806, 0.1999]), 'concerned': np.array([0.2854, 0.2667, 0.3265, 0.2367]), 'normal': np.array([0.165, 0.2322, 0.2711, 0.3317]), 'growth': np.array([0.2, 0.205, 0.3735, 0.0649])}
