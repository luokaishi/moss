...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.25, 0.25, 0.25, 0.25]), 'concerned': np.array([0.2854, 0.2667, 0.3265, 0.2367]), 'normal': np.array([0.1296, 0.2608, 0.2781, 0.3315]), 'growth': np.array([0.2, 0.205, 0.3735, 0.0649])}
