...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.7, 0.1, 0.1, 0.1]), 'concerned': np.array([0.2726, 0.3134, 0.2456, 0.1684]), 'normal': np.array([0.1086, 0.4872, 1.0229, 0.3133]), 'growth': np.array([0.2256, 0.4288, 0.2049, 0.497])}
