...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.1, 0.5475, 0.1, 0.1025]), 'concerned': np.array([0.2497, 0.2026, 0.276, 0.1469]), 'normal': np.array([0.4353, 0.3064, 0.9492, 0.01]), 'growth': np.array([0.0881, 0.1629, 0.7427, 0.1623])}
