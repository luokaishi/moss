...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.5, 0.24, 0.2, 0.1]), 'concerned': np.array([0.292, 0.2513, 0.2262, 0.2305]), 'normal': np.array([0.0707, 0.5052, 0.7816, 0.2424]), 'growth': np.array([0.6063, 0.3019, 0.2128, 0.2808])}
