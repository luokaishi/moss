...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.2, 0.4432, 0.1, 0.2239]), 'concerned': np.array([0.3729, 0.35, 0.2149, 0.1]), 'normal': np.array([0.1779, 0.2877, 0.3659, 0.1685]), 'growth': np.array([0.196, 0.2401, 0.2843, 0.2542])}
