...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.4, 0.3, 0.2, 0.1]), 'concerned': np.array([0.4193, 0.148, 0.295, 0.1377]), 'normal': np.array([0.0124, 0.3758, 0.63, 0.2067]), 'growth': np.array([0.6778, 0.2932, 0.3756, 0.2646])}
