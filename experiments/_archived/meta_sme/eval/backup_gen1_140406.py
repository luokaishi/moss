...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.278, 0.3292, 0.1853, 0.2075]), 'concerned': np.array([0.3037, 0.2333, 0.2392, 0.1683]), 'normal': np.array([0.1462, 0.4331, 0.3131, 0.1076]), 'growth': np.array([0.1728, 0.231, 0.2449, 0.3513])}
