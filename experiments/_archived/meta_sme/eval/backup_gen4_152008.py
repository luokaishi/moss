...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.1749, 0.4208, 0.2414, 0.303]), 'concerned': np.array([0.3415, 0.3356, 0.1779, 0.1601]), 'normal': np.array([0.1702, 0.2965, 1.1606, 0.0511]), 'growth': np.array([0.2718, 0.3871, 0.2405, 0.5091])}
