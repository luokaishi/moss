...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.5487, 0.193, 0.1184, 0.0229]), 'concerned': np.array([0.2683, 0.2811, 0.4063, 0.1737]), 'normal': np.array([0.3576, 0.3418, 0.8815, 0.01]), 'growth': np.array([0.0958, 0.3726, 0.3703, 0.01])}
