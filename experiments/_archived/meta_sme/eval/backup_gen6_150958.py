...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.1, 0.1, 0.1, 0.7]), 'concerned': np.array([0.1891, 0.1593, 0.2724, 0.2882]), 'normal': np.array([0.1634, 0.2965, 1.5551, 0.0139]), 'growth': np.array([0.2413, 0.3305, 0.2405, 0.292])}
