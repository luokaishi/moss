...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.7, 0.1, 0.1, 0.1]), 'concerned': np.array([0.1922, 0.2566, 0.2225, 0.3704]), 'normal': np.array([0.0075, 0.3626, 1.0229, 0.0081]), 'growth': np.array([0.238, 0.3957, 0.2509, 0.497])}
