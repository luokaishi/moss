...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.4092, 0.26, 0.1439, 0.1868]), 'concerned': np.array([0.1342, 0.3046, 0.4135, 0.2318]), 'normal': np.array([0.1454, 0.2293, 1.0882, 0.01]), 'growth': np.array([0.312, 0.3291, 0.0155, 0.1357])}
