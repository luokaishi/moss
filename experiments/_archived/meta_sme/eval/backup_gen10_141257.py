...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.2, 0.5, 0.1, 0.2]), 'concerned': np.array([0.35, 0.35, 0.2, 0.3573]), 'normal': np.array([0.2369, 0.3631, 0.3012, 0.1359]), 'growth': np.array([0.022, 0.189, 0.513, 0.1839])}
