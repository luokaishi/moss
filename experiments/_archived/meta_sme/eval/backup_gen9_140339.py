...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.4001, 0.3041, 0.1828, 0.01]), 'concerned': np.array([0.3283, 0.262, 0.1824, 0.2272]), 'normal': np.array([0.2495, 0.373, 0.4732, 0.2756]), 'growth': np.array([0.29, 0.2449, 0.2959, 0.1692])}
