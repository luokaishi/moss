...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.0924, 0.1192, 0.147, 0.6509]), 'concerned': np.array([0.3193, 0.3037, 0.1364, 0.2406]), 'normal': np.array([0.0075, 0.4035, 1.0229, 0.3133]), 'growth': np.array([0.2381, 0.3607, 0.2049, 0.497])}
