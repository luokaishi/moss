...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.4, 0.3, 0.2, 0.1379]), 'concerned': np.array([0.3037, 0.2333, 0.2392, 0.1683]), 'normal': np.array([0.1462, 0.4331, 0.3131, 0.1076]), 'growth': np.array([0.2149, 0.1618, 0.2992, 0.3586])}
