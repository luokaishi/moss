...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.2188, 0.3004, 0.2848, 0.196]), 'concerned': np.array([0.293, 0.4737, 0.2143, 0.3573]), 'normal': np.array([0.2382, 0.3631, 0.6053, 0.1359]), 'growth': np.array([0.0263, 0.133, 0.4217, 0.1732])}
