...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.2534, 0.3187, 0.1915, 0.2364]), 'concerned': np.array([0.1537, 0.3809, 0.289, 0.3605]), 'normal': np.array([0.0703, 0.3135, 0.952, 0.01]), 'growth': np.array([0.312, 0.2905, 0.01, 0.0715])}
