...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.2, 0.5, 0.1, 0.162]), 'concerned': np.array([0.2957, 0.1992, 0.2432, 0.2619]), 'normal': np.array([0.0091, 0.3626, 1.0229, 0.0081]), 'growth': np.array([0.2682, 0.3957, 0.1575, 0.497])}
