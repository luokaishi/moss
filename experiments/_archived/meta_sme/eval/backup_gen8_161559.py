...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.485, 0.2378, 0.1894, 0.0877]), 'concerned': np.array([0.3645, 0.1601, 0.2372, 0.2382]), 'normal': np.array([0.01, 0.3843, 0.63, 0.2067]), 'growth': np.array([0.7167, 0.4095, 0.1958, 0.2646])}
