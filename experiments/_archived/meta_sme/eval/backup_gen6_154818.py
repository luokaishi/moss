...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.4396, 0.1677, 0.168, 0.2246]), 'concerned': np.array([0.2436, 0.1036, 0.2658, 0.01]), 'normal': np.array([0.0707, 0.4282, 0.7881, 0.3825]), 'growth': np.array([0.4616, 0.393, 0.2706, 0.2333])}
