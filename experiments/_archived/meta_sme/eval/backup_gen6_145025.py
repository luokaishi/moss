...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.2314, 0.4247, 0.1373, 0.2065]), 'concerned': np.array([0.1434, 0.2864, 0.1777, 0.3926]), 'normal': np.array([0.0703, 0.3064, 0.952, 0.01]), 'growth': np.array([0.312, 0.2905, 0.223, 0.1745])}
