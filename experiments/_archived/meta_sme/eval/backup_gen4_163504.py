...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.1135, 0.0817, 0.1496, 0.6552]), 'concerned': np.array([0.2826, 0.2321, 0.3408, 0.1445]), 'normal': np.array([0.01, 0.3758, 0.63, 0.2067]), 'growth': np.array([0.6778, 0.2932, 0.3756, 0.2646])}
