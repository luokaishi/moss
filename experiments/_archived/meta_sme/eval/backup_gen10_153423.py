...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.2, 0.3918, 0.1, 0.2]), 'concerned': np.array([0.3897, 0.2725, 0.2242, 0.1136]), 'normal': np.array([0.1086, 0.4872, 0.8228, 0.3849]), 'growth': np.array([0.2256, 0.3318, 0.2049, 0.497])}
