...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.4001, 0.3086, 0.1828, 0.01]), 'concerned': np.array([0.2937, 0.2492, 0.1501, 0.237]), 'normal': np.array([0.2495, 0.373, 0.4089, 0.141]), 'growth': np.array([0.263, 0.279, 0.2837, 0.1743])}
