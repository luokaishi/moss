...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.1904, 0.2536, 0.2622, 0.2938]), 'concerned': np.array([0.1122, 0.3397, 0.2746, 0.357]), 'normal': np.array([0.0703, 0.2959, 0.99, 0.01]), 'growth': np.array([0.312, 0.3291, 0.01, 0.1753])}
