...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.0799, 0.6149, 0.1603, 0.145]), 'concerned': np.array([0.2916, 0.231, 0.1988, 0.2787]), 'normal': np.array([0.0075, 0.3626, 1.0229, 0.0081]), 'growth': np.array([0.238, 0.3957, 0.1247, 0.497])}
