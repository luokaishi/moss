...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.4418, 0.2556, 0.1925, 0.1101]), 'concerned': np.array([0.3606, 0.2167, 0.2586, 0.3609]), 'normal': np.array([0.01, 0.3843, 0.63, 0.2067]), 'growth': np.array([0.7167, 0.4095, 0.2488, 0.2646])}
