...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.2, 0.5, 0.1, 0.2]), 'concerned': np.array([0.3049, 0.4737, 0.2214, 0.3925]), 'normal': np.array([0.2382, 0.4514, 0.8342, 0.01]), 'growth': np.array([0.0263, 0.144, 0.422, 0.0564])}
