...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.7, 0.131, 0.1, 0.1]), 'concerned': np.array([0.2928, 0.2301, 0.2146, 0.2625]), 'normal': np.array([0.01, 0.2965, 1.0229, 0.01]), 'growth': np.array([0.2682, 0.2896, 0.26, 0.5091])}
