...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.3892, 0.3861, 0.1687, 0.083]), 'concerned': np.array([0.2497, 0.2026, 0.276, 0.1469]), 'normal': np.array([0.3576, 0.2811, 0.9492, 0.01]), 'growth': np.array([0.0725, 0.1872, 0.6464, 0.1486])}
