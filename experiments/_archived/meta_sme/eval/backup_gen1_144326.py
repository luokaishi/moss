...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.5999, 0.2, 0.2, 0.1]), 'concerned': np.array([0.3349, 0.1967, 0.27, 0.1983]), 'normal': np.array([0.1722, 0.3064, 0.952, 0.1354]), 'growth': np.array([0.3027, 0.1869, 0.3953, 0.2212])}
