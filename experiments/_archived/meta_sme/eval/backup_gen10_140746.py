...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.4, 0.3489, 0.2, 0.1]), 'concerned': np.array([0.2331, 0.2626, 0.2966, 0.1692]), 'normal': np.array([0.1356, 0.304, 0.248, 0.2758]), 'growth': np.array([0.2, 0.1717, 0.4, 0.0552])}
