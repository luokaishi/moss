...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.1292, 0.2646, 0.1207, 0.5052]), 'concerned': np.array([0.3375, 0.2491, 0.0614, 0.0814]), 'normal': np.array([0.1579, 0.3705, 0.2078, 0.01]), 'growth': np.array([0.1862, 0.2548, 0.5869, 0.1364])}
