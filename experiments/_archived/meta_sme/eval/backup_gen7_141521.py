...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.25, 0.25, 0.3297, 0.25]), 'concerned': np.array([0.35, 0.291, 0.2, 0.3573]), 'normal': np.array([0.2369, 0.3631, 0.3914, 0.1359]), 'growth': np.array([0.0243, 0.0767, 0.513, 0.1732])}
