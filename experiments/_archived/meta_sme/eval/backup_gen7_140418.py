...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.2084, 0.0787, 0.5895, 0.1234]), 'concerned': np.array([0.3007, 0.3066, 0.2279, 0.1648]), 'normal': np.array([0.1462, 0.4331, 0.3131, 0.1076]), 'growth': np.array([0.2601, 0.1903, 0.2026, 0.347])}
