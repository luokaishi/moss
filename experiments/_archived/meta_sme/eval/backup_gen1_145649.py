...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.1807, 0.3445, 0.2246, 0.25]), 'concerned': np.array([0.1342, 0.3046, 0.4135, 0.2937]), 'normal': np.array([0.0667, 0.2959, 0.8953, 0.01]), 'growth': np.array([0.312, 0.3291, 0.01, 0.1357])}
