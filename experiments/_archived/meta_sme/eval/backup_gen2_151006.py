...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.1784, 0.1695, 0.1544, 0.4978]), 'concerned': np.array([0.1534, 0.2991, 0.291, 0.2565]), 'normal': np.array([0.1634, 0.2965, 1.5551, 0.0139]), 'growth': np.array([0.2413, 0.3305, 0.2405, 0.292])}
