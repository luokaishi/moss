...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.4571, 0.1645, 0.2234, 0.1551]), 'concerned': np.array([0.35, 0.4396, 0.2444, 0.1]), 'normal': np.array([0.1063, 0.4024, 0.194, 0.375]), 'growth': np.array([0.2, 0.2002, 0.4, 0.0472])}
