...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.4, 0.3, 0.2, 0.1]), 'concerned': np.array([0.3054, 0.278, 0.2071, 0.2095]), 'normal': np.array([0.2495, 0.373, 0.2365, 0.141]), 'growth': np.array([0.2, 0.2, 0.4, 0.2])}
