...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.7, 0.1, 0.1, 0.1]), 'concerned': np.array([0.4086, 0.35, 0.2549, 0.1]), 'normal': np.array([0.162, 0.391, 0.2535, 0.1935]), 'growth': np.array([0.196, 0.2401, 0.2843, 0.2797])}
