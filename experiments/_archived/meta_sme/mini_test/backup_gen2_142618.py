...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.4885, 0.1688, 0.2033, 0.1394]), 'concerned': np.array([0.0219, 0.371, 0.2407, 0.3663]), 'normal': np.array([0.2382, 0.2664, 0.8815, 0.01]), 'growth': np.array([0.0203, 0.1422, 0.4577, 0.0427])}
