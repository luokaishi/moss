...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.3231, 0.1062, 0.2325, 0.5128]), 'concerned': np.array([0.35, 0.35, 0.2008, 0.1]), 'normal': np.array([0.1366, 0.4, 0.3, 0.1045]), 'growth': np.array([0.1734, 0.1746, 0.4062, 0.2458])}
