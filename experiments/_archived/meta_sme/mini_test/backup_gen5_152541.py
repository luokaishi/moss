...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.1335, 0.0929, 0.652, 0.1511]), 'concerned': np.array([0.3103, 0.2455, 0.2106, 0.2336]), 'normal': np.array([0.0081, 0.3626, 1.0229, 0.01]), 'growth': np.array([0.2682, 0.2896, 0.2532, 0.497])}
