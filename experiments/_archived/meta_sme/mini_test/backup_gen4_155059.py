...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.25, 0.25, 0.25, 0.3494]), 'concerned': np.array([0.2436, 0.1247, 0.2658, 0.01]), 'normal': np.array([0.0707, 0.4269, 0.8109, 0.2854]), 'growth': np.array([0.6063, 0.3019, 0.2128, 0.2808])}
