...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.5, 0.2651, 0.2, 0.3003]), 'concerned': np.array([0.3124, 0.3996, 0.1779, 0.1601]), 'normal': np.array([0.1702, 0.2965, 1.0229, 0.01]), 'growth': np.array([0.2718, 0.3871, 0.2405, 0.5091])}
