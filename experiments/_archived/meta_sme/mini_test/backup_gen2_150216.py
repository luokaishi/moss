...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.0924, 0.1025, 0.7705, 0.1]), 'concerned': np.array([0.2287, 0.2682, 0.3007, 0.2023]), 'normal': np.array([0.1634, 0.2293, 1.3693, 0.0139]), 'growth': np.array([0.2432, 0.4836, 0.065, 0.2175])}
