...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.0106, 0.1014, 0.1993, 0.5608]), 'concerned': np.array([0.3606, 0.2167, 0.2586, 0.3609]), 'normal': np.array([0.01, 0.3843, 0.63, 0.1813]), 'growth': np.array([0.6494, 0.4095, 0.2488, 0.2646])}
