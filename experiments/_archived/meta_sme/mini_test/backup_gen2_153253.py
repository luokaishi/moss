...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.1887, 0.4119, 0.2987, 0.1662]), 'concerned': np.array([0.4035, 0.2273, 0.2137, 0.1555]), 'normal': np.array([0.1086, 0.4035, 1.0229, 0.3133]), 'growth': np.array([0.2256, 0.4288, 0.2049, 0.497])}
