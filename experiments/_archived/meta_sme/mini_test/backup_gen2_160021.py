...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.5, 0.2, 0.2, 0.1]), 'concerned': np.array([0.292, 0.2737, 0.2586, 0.237]), 'normal': np.array([0.1077, 0.4561, 0.7816, 0.1993]), 'growth': np.array([0.6063, 0.3552, 0.2557, 0.2808])}
