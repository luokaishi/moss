...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.3169, 0.1785, 0.2221, 0.2825]), 'concerned': np.array([0.35, 0.3852, 0.2444, 0.1]), 'normal': np.array([0.1356, 0.304, 0.248, 0.2758]), 'growth': np.array([0.2, 0.2002, 0.4, 0.0552])}
