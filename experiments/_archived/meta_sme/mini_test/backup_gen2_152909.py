...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.1321, 0.1192, 0.147, 0.6688]), 'concerned': np.array([0.2488, 0.1955, 0.2333, 0.2654]), 'normal': np.array([0.0075, 0.4035, 1.0229, 0.0085]), 'growth': np.array([0.238, 0.3957, 0.2509, 0.497])}
