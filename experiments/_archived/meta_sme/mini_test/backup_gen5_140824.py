...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.1, 0.1, 0.1, 0.7]), 'concerned': np.array([0.1701, 0.2667, 0.3265, 0.2367]), 'normal': np.array([0.1588, 0.2623, 0.2912, 0.3186]), 'growth': np.array([0.2, 0.1868, 0.3735, 0.0649])}
