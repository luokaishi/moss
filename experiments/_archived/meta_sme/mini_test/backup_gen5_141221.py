...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.25, 0.2834, 0.25, 0.25]), 'concerned': np.array([0.35, 0.35, 0.2, 0.2279]), 'normal': np.array([0.3324, 0.4, 0.211, 0.1]), 'growth': np.array([0.1746, 0.189, 0.513, 0.2])}
