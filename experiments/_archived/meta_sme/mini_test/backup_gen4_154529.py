...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.0969, 0.5889, 0.213, 0.1013]), 'concerned': np.array([0.3756, 0.3831, 0.2658, 0.01]), 'normal': np.array([0.0707, 0.3106, 0.7881, 0.3825]), 'growth': np.array([0.2801, 0.3924, 0.2554, 0.2143])}
