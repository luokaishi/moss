...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.1, 0.7, 0.1, 0.1]), 'concerned': np.array([0.1815, 0.293, 0.3483, 0.1772]), 'normal': np.array([0.1454, 0.2293, 1.0882, 0.01]), 'growth': np.array([0.312, 0.4832, 0.0155, 0.1357])}
