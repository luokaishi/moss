...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.01, 0.1, 0.1052, 0.7]), 'concerned': np.array([0.2703, 0.35, 0.1081, 0.1]), 'normal': np.array([0.1653, 0.247, 0.1698, 0.1]), 'growth': np.array([0.2, 0.2, 0.5573, 0.2])}
