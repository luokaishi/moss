...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.348, 0.1766, 0.2535, 0.2218]), 'concerned': np.array([0.35, 0.4396, 0.2444, 0.1]), 'normal': np.array([0.1063, 0.4024, 0.194, 0.3393]), 'growth': np.array([0.2, 0.2002, 0.4, 0.0552])}
