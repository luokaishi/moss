...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.1734, 0.5309, 0.0988, 0.1968]), 'concerned': np.array([0.3049, 0.3733, 0.2214, 0.3925]), 'normal': np.array([0.2382, 0.4514, 0.7981, 0.01]), 'growth': np.array([0.0263, 0.144, 0.4577, 0.0564])}
