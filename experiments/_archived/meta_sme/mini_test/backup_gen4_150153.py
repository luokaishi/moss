...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.1, 0.1, 0.7, 0.1]), 'concerned': np.array([0.2279, 0.2663, 0.3303, 0.2148]), 'normal': np.array([0.1634, 0.2293, 1.3693, 0.01]), 'growth': np.array([0.266, 0.4746, 0.0166, 0.2429])}
