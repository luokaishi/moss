...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.3356, 0.2989, 0.1895, 0.1761]), 'concerned': np.array([0.1823, 0.243, 0.3136, 0.2611]), 'normal': np.array([0.1634, 0.2965, 1.5551, 0.0139]), 'growth': np.array([0.2413, 0.3305, 0.2405, 0.3483])}
