...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.1, 0.1, 0.1, 0.7]), 'concerned': np.array([0.2003, 0.2406, 0.3413, 0.2179]), 'normal': np.array([0.1634, 0.2293, 1.0882, 0.01]), 'growth': np.array([0.312, 0.4832, 0.0155, 0.1357])}
