...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.1404, 0.1157, 0.5782, 0.1233]), 'concerned': np.array([0.2278, 0.2303, 0.3456, 0.1964]), 'normal': np.array([0.1634, 0.2293, 1.3693, 0.0139]), 'growth': np.array([0.1802, 0.474, 0.1648, 0.181])}
