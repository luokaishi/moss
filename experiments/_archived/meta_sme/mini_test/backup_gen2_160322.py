...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.106, 0.2151, 0.0394, 0.6419]), 'concerned': np.array([0.3606, 0.2737, 0.2586, 0.2295]), 'normal': np.array([0.01, 0.4561, 0.8596, 0.1993]), 'growth': np.array([0.636, 0.3552, 0.2557, 0.2808])}
