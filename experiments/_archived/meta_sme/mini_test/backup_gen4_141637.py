...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.3586, 0.2357, 0.2632, 0.1424]), 'concerned': np.array([0.293, 0.342, 0.2143, 0.3573]), 'normal': np.array([0.2413, 0.3631, 0.5401, 0.1359]), 'growth': np.array([0.0291, 0.133, 0.5517, 0.1732])}
