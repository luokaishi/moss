...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.1909, 0.5048, 0.0844, 0.2199]), 'concerned': np.array([0.293, 0.342, 0.2143, 0.3573]), 'normal': np.array([0.2382, 0.3631, 0.6053, 0.1359]), 'growth': np.array([0.0263, 0.133, 0.5517, 0.1732])}
