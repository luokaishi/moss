...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.4576, 0.2651, 0.2, 0.3003]), 'concerned': np.array([0.2565, 0.3569, 0.1933, 0.1932]), 'normal': np.array([0.1702, 0.2965, 1.0229, 0.01]), 'growth': np.array([0.2718, 0.2896, 0.26, 0.5091])}
