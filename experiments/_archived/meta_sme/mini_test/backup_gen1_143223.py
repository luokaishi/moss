...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.5386, 0.2, 0.2, 0.1]), 'concerned': np.array([0.1923, 0.3705, 0.3875, 0.1357]), 'normal': np.array([0.3576, 0.3418, 0.8815, 0.01]), 'growth': np.array([0.0409, 0.3361, 0.5095, 0.0436])}
