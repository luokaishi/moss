...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.4983, 0.2197, 0.1599, 0.0995]), 'concerned': np.array([0.2497, 0.2495, 0.276, 0.1469]), 'normal': np.array([0.2245, 0.3064, 0.9492, 0.0082]), 'growth': np.array([0.1683, 0.2072, 0.4637, 0.184])}
