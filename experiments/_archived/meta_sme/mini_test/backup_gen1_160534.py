...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.5112, 0.0799, 0.2763, 0.1326]), 'concerned': np.array([0.292, 0.3138, 0.2077, 0.2396]), 'normal': np.array([0.1653, 0.4, 0.3, 0.1857]), 'growth': np.array([0.1953, 0.2712, 0.3614, 0.1698])}
