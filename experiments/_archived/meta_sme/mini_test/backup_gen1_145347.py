...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.2171, 0.3375, 0.1604, 0.285]), 'concerned': np.array([0.1122, 0.3809, 0.289, 0.3605]), 'normal': np.array([0.0703, 0.2959, 0.952, 0.01]), 'growth': np.array([0.312, 0.2905, 0.0655, 0.0633])}
