...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.4001, 0.3041, 0.1828, 0.01]), 'concerned': np.array([0.2356, 0.3136, 0.1571, 0.2938]), 'normal': np.array([0.2495, 0.373, 0.4732, 0.2756]), 'growth': np.array([0.2894, 0.2235, 0.2683, 0.2188])}
