...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.1404, 0.1157, 0.6205, 0.1233]), 'concerned': np.array([0.2957, 0.2682, 0.3007, 0.2023]), 'normal': np.array([0.1634, 0.2293, 1.3693, 0.0139]), 'growth': np.array([0.2432, 0.4836, 0.065, 0.2175])}
