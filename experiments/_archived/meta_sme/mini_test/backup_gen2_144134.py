...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.7, 0.1, 0.1, 0.1]), 'concerned': np.array([0.2497, 0.2495, 0.276, 0.1469]), 'normal': np.array([0.1722, 0.3064, 0.9492, 0.0082]), 'growth': np.array([0.1683, 0.2072, 0.4637, 0.184])}
