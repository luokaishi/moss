...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.1888, 0.5963, 0.0801, 0.1348]), 'concerned': np.array([0.2121, 0.1593, 0.2724, 0.2882]), 'normal': np.array([0.1634, 0.2451, 1.5551, 0.0139]), 'growth': np.array([0.2413, 0.3305, 0.1587, 0.232])}
