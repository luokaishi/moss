...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.5, 0.2, 0.1872, 0.1]), 'concerned': np.array([0.2497, 0.2495, 0.276, 0.1469]), 'normal': np.array([0.2245, 0.3064, 0.9492, 0.01]), 'growth': np.array([0.1451, 0.2072, 0.4637, 0.184])}
