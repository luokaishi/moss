...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.5845, 0.1317, 0.1805, 0.1033]), 'concerned': np.array([0.2436, 0.2009, 0.2658, 0.01]), 'normal': np.array([0.0707, 0.3106, 0.7881, 0.3825]), 'growth': np.array([0.4616, 0.393, 0.2706, 0.2872])}
