...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.0924, 0.1192, 0.147, 0.6509]), 'concerned': np.array([0.2845, 0.2353, 0.1823, 0.2728]), 'normal': np.array([0.0075, 0.4035, 1.0229, 0.1591]), 'growth': np.array([0.2381, 0.3957, 0.2049, 0.497])}
