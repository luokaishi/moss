...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.2, 0.5, 0.1, 0.314]), 'concerned': np.array([0.3174, 0.1836, 0.3146, 0.1919]), 'normal': np.array([0.0074, 0.2965, 1.0229, 0.01]), 'growth': np.array([0.2682, 0.2896, 0.26, 0.497])}
