...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.1, 0.1, 0.1, 0.7]), 'concerned': np.array([0.272, 0.3502, 0.2204, 0.1575]), 'normal': np.array([0.1772, 0.34, 0.2369, 0.2459]), 'growth': np.array([0.221, 0.1845, 0.3446, 0.2499])}
