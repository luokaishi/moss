...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.1126, 0.1, 0.1, 0.7]), 'concerned': np.array([0.3214, 0.2434, 0.1584, 0.2768]), 'normal': np.array([0.2, 0.2794, 0.3, 0.1]), 'growth': np.array([0.2, 0.2, 0.4, 0.2])}
