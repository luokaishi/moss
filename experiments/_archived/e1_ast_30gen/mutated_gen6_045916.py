...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.5277, 0.1387, 0.1868, 0.1468]), 'concerned': np.array([0.262, 0.3104, 0.1895, 0.2381]), 'normal': np.array([0.2, 0.4, 0.3, 0.1]), 'growth': np.array([0.3301, 0.1415, 0.3533, 0.175])}
