...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.4434, 0.087, 0.3092, 0.1603]), 'concerned': np.array([0.35, 0.35, 0.2, 0.1]), 'normal': np.array([0.2041, 0.3119, 0.3352, 0.1488]), 'growth': np.array([0.2, 0.2, 0.4, 0.2])}
