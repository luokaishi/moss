...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.0769, 0.1, 0.7, 0.1]), 'concerned': np.array([0.3027, 0.2195, 0.232, 0.2458]), 'normal': np.array([0.1497, 0.2724, 0.2507, 0.1192]), 'growth': np.array([0.2, 0.2, 0.4, 0.2])}
