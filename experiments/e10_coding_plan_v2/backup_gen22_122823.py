...
class UnifiedMOSSAgent(BaseMOSSAgent):
    ...
    def _apply_state_weights(self):
        ...
        """
        STATE_WEIGHTS = {'crisis': np.array([0.659, 0.1423, 0.1205, 0.0782]), 'concerned': np.array([0.35, 0.3962, 0.2, 0.1]), 'normal': np.array([0.2, 0.4214, 0.0874, 0.1617]), 'growth': np.array([0.0418, 0.2, 0.4, 0.2])}
