...
def run_minigrid_validation(episodes=100, max_steps=50):
    """运行 MiniGrid 验证实验"""
    print("="*60)
    print("MiniGrid Validation Experiment - MOSS v6.3")
    print("="*60)
    ...
    # 保存结果
    output_path = Path('logs/minigrid_v6.3')
...
if __name__ == '__main__':
    run_minigrid_validation(episodes=100, max_steps=50)
